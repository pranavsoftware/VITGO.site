    ...
    onSnapshot(usersQuery, snapshot => {
        ...
        snapshot.forEach(async docSnapshot => {
            ...
            if (userData.email !== currentUser.email) { // Exclude the current user
                ...
                img.src = userData.faceScan || 'assets/defaultAvatar.jpg'; // Use faceScan as profile picture or fallback to default
...
async function loadNotifications(currentUser) {
    ...
    onSnapshot(notificationsQuery, snapshot => {
        ...
        snapshot.forEach(async docSnapshot => {
            ...
            senderImg.src = senderData.photoURL || 'default Avatar .jpg';
            senderImg.alt = senderData.displayName;
            senderImg.classList.add('sender-profile-pic');
            ...
            senderName.textContent = senderData.displayName;
